...
shapes using a generic non-recursive algorithm on a canvas_store. 
...
class non_recursive_fill_tool: public abstract_tool
{
public:
	// Initialize the tool and store a reference of a canvas_store
	non_recursive_fill_tool(canvas_store &canvas);
