...
application::application()
{
	...
	canvas = new canvas_store(100, 100);
...
void application::set_tool(abstract_tool *new_tool)
{
	if (tool)
		delete tool;
...
void application::display()
{
	...
	glutBitmapString(GLUT_BITMAP_HELVETICA_12, (const unsigned char*)stream.str().c_str());
